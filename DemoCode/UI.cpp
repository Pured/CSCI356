...
void DemoApp::createUI()
{
	...
	controlsUI = mTrayMgr->createTextBox(OgreBites::TL_TOPRIGHT, "ControlsPanel", "Controls", 510, 550);
	...
	controlsUI->appendText("PG Up: Create a tank.\n");
	controlsUI->appendText("PG Down: Remove a tank.\n");
